...
export const DEFAULT_COMPONENT_CATALOGUE: CatalogueSeed[] = [
  ...
  // Deductions
  { category: "deduction", code: "LOAN", name: "Staff Loan Repayment", description: "Scheduled loan recovery", calculation_type: "amount", calculation_basis: "fixed", frequency: "monthly", tax_treatment: "post_tax", affects_gross_pay: false, display_order: 10, payslip_label: "Loan", priority: 210 },
