-- SECURE ROLE SECURITY IMPLEMENTATION - CORRECTED VERSION
-- This script implements proper role-based access control with company isolation
-- Applied to the working commit b41a142
...
AS $$
  ...
  -- In production, this should get the company_id from user metadata
...
ALTER TABLE IF EXISTS security_analytics DISABLE ROW LEVEL SECURITY;
...
-- COMPANY_SETTINGS TABLE - Admin only (simplified without company_id check)
