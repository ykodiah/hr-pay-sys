...
export default function EnhancedDocumentVaultPage() {
  ...
  const getFileIcon = (fileType: string) => {
    ...
    if (fileType.startsWith("audio/")) return <MusicIcon className="w-5 h-5" />
      ...
      switch (action) {
        ...
        case "audit":
          ...
          if (auditDoc) {
            ...
            setIsAuditOpen(true)
            await loadData() // Reload to get fresh audit logs
          }
          break
        case "workflow":
