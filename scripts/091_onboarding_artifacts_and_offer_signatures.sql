...
-- Task uploads / typed responses (synced to document vault)
...
-- Offer letter signatures (Candidate + HR Head)
...
-- Optional link from vault rows back to onboarding checklist
